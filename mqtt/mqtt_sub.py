...
from .callbacks.callbacks import on_connect, on_subscribe, on_message
from mqtt.callbacks.callbacks import MessageList


class MqttClientConnection:
    def __init__(self, broker_ip: str, port: int, client_name: str, keepalive=60, thread_name=None):
...
def mqtt_start_sub(thread_name=None):
    ...
    mqtt_client_connection = MqttClientConnection(broker_ip="localhost",
